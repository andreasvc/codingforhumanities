...
% Notes:
% - print not introduced as function; type also mentioned without introduction
% - explain difference between int('42') and int(a)
% - stress difference between evaluating an expression, and storing the result in
%   a variable; e.g., "int(a)" has no side-effect.
% - the course summary slide does not really have a summary of the course,
...
\begin{frame}{Programming: informal understanding}
    ...
    a sequence of \structure{unambiguous executable instructions} \\
    to perform a task.
\end{frame}
...
\begin{frame}[fragile]{Numeric data types}
    \begin{description}[Floating point]
...
\begin{frame}[fragile]{Variables}
    \begin{definition}
        A \structure{variable} holds the result of an expression
...
\pause
\begin{definition}
\structure{Assignment}: \lstinline{name = expression}
...
\begin{frame}{Some advice}
    \begin{itemize}
        ...
        \item Study book \& slides, \structure{practice}
...
\begin{frame}{Administrative matters}
    \begin{itemize}
        ...
        \item On Brightspace, under Content, each week has:
            ...
            \end{itemize}
        \item Grades will be on Brightspace %under My Gradebook
    \end{itemize}
\end{frame}

\begin{frame}{Administrative matters}
    \begin{itemize}
        \item \structure{Don't email} about course content,
