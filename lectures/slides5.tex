...
\begin{frame}{(De)motivational quotations}
...
\begin{frame}{Good code: Refactoring}
    ...
    % FIXME: already mention in previous lectures
...
\section{Keyword analysis} % FIXME better title?
...
\begin{lstlisting}
In: moby_dick = nltk.Text(open('MELVILLE, Herman - Moby Dick.txt').read().split())
In: austen_sense = nltk.Text(
        open('AUSTEN, Jane - Sense and Sensibility.txt').read().split())
\end{lstlisting}
\end{frame}
...
own-Ho's Story. CHAPTER 55. Of the Monstrous Pictures of Whales. CHAPTER 56. Of
mong the former, one was of a most monstrous size.... This came towards us, ope
ion of the Psalms_. "Touching that monstrous bulk of the whale or ork we have r
ll over with a heathenish array of monstrous clubs and spears. Some were thickl
ed as you gazed, and wondered what monstrous cannibal and savage could ever hav
...
th of Radney.'" CHAPTER 55. Of the Monstrous Pictures of Whales. I shall ere lo
...
de of Whale-Bones; for Whales of a monstrous size are oftentimes cast up dead u
\end{lstlisting}
\end{frame}
...
Insight: monstrous is positive for Austen!
\end{frame}
...
ohn. "Now, Palmer, you shall see a monstrous pretty girl." He immediately went
...
\begin{definition}
    ...
    unusually often. Thus red wine is a collocation, whereas the wine is not.
    (source: NLTK book)
\end{definition}
\begin{lstlisting}
In: moby_dick.collocations()
Sperm Whale; Moby Dick; White Whale; Sperm Whale's; Sperm Whale,;
Captain Ahab; Moby Dick.; old man; Right Whale; old man's; Captain
Peleg; sperm whale; White Whale?"; Moby Dick,; Pequod Meets; cried
Ahab,; Father Mapple; Cape Horn; would fain; New Bedford
In: austen_sense.collocations()
Mrs. Jennings; Lady Middleton; Mrs. Jennings,; Colonel Brandon; Sir
John; Mrs. Dashwood; every thing; Colonel Brandon,; Mrs. Ferrars; Mrs.
Jennings's; said she,; Colonel Brandon's; Sir John,; said Elinor,;
...
% move on to scikit-learn for extracting keywords with statistics
...
\begin{frame}[fragile]{Keyness: chi-square}
    Compare two (sets of) texts (identified by \texttt{labels}),\\
